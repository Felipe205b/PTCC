...
import { View, Text, TouchableOpacity, TextInput, Image, StyleSheet, Pressable, Keyboard} from "react-native";
    ...
    return(
        <Pressable style={{width:"100%", height:"100%"}}
            ...
            <View style={styles.conteiner}>
                ...
                <Text> Salve a senha</Text>
                </View>
                <View style={styles.linhas}>
                    <View style={styles.linha1}></View>
                    <Text style={{fontSize:17, marginHorizontal:10,}}>OU</Text>
